...
SECRET_KEY = 'django-insecure-##!igv0d^bshm_xwoa%lt9eamp2x7%+(oib4odgl-pkz2na!d3'
...
USE_TZ = True
TIME_ZONE = 'Asia/Kolkata'  # Set your timezone (use 'Asia/Kolkata' for Indian Standard Time)
